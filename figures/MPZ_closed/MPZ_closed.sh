...
input_dir="data/MPZ_closed"
output_dir="output/MPZ_closed"
plot_dir="figures/MPZ_closed"
output_file="MPZ14_50.txt"
...
pdflatex -output-directory ${plot_dir} "\def\data_dir{$plot_dir} \input{MPZ_closed.tex}" &
